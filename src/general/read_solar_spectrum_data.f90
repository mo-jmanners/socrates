...
! *****************************COPYRIGHT*******************************
!
! Subroutine to read a solar spectrum from an open file unit
!
SUBROUTINE read_solar_spectrum_data(iu_solar, SolarSpec, ierr)

! Description:
!   The solar spectrum is read as a file of irradiances against wavelengths.
...
END SUBROUTINE read_solar_spectrum_data
