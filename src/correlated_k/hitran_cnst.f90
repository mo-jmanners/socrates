...
MODULE hitran_cnst
  ...
  INTEGER, Parameter :: number_molecules = 61
  INTEGER, Parameter :: number_species   = 156
  ...
  CHARACTER(LEN=6), Parameter, DIMENSION(number_molecules) :: molecule_names = &
    (/"   H2O", "   CO2", "    O3", "   N2O", "    CO", "   CH4", "    O2", & !  1-7
      ...
      "    SO", "  CH3F", "  GeH4", "   CS2", "  CH3I", "   NF3", "   H3+", & ! 50-56
      "   CH3", "    S2", " COFCl", "  HONO", " ClNO2" /)                     ! 57-61
  ...
  REAL(RealK), Parameter, DIMENSION(1:number_species) :: iso_abundance = &
    (/ 9.97317E-01, 1.99983E-03, 3.71884E-04, 3.10693E-04, 6.23003E-07, & !  1: H2O
       ...
       9.91616E-01, 3.64564E-03, 3.97679E-03, &                           ! 10: NO2
       ...
       9.83898E-01, 1.10539E-02, &                                        ! 32: HCOOH
       9.95107E-01, &                                                     ! 33: HO2
       9.97628E-01, &                                                     ! 34: O
       ...
       9.88428E-01, 1.11048E-02, &                                        ! 51: CH3F
       ...
       9.88428E-01, &                                                     ! 57: CH3
       9.02842E-01, &                                                     ! 58: S2
       7.47510E-01, 2.39035E-01, &                                        ! 59: COFCl
       9.91461E-01, &                                                     ! 60: HONO
       7.51352E-01, 2.40264E-01 /)                                        ! 61: ClNO2
  ...
  REAL(RealK), Parameter, DIMENSION(1:number_species) :: q296 = &
    (/ 1.7458E+02, 1.7605E+02, 1.0521E+03, 8.6474E+02, 8.7557E+02, & !  1: H2O
       ...
       7.1413E+03, 3.2342E+02, 3.7660E+03, 1.0972E+04, 6.5224E+02, &
       7.5950E+03, 2.2120E+04, &
       3.4750E+03, 7.5846E+03, 3.7030E+03, 4.4044E+04, 2.1742E+04, & !  3: O3
       4.9850E+03, 3.3507E+03, 3.4472E+03, 5.2969E+03, 3.0868E+04, & !  4: N2O
       1.0742E+02, 2.2470E+02, 1.1278E+02, 6.6118E+02, 2.3644E+02, & !  5: CO
       1.3847E+03, &
       5.9053E+02, 1.1811E+03, 4.7948E+03, 9.6010E+03, &             !  6: CH4
       2.1574E+02, 4.5523E+02, 2.6581E+03, &                         !  7: O2
       1.1411E+03, 7.8831E+02, 1.2028E+03, &                         !  8: NO
       6.3391E+03, 6.3678E+03, 2.5607E+04, 1.3681E+04, &             !  9: SO2
       1.3622E+04, 9.3216E+03, 2.9082E+04, &                         ! 10: NO2
       1.7252E+03, 1.1533E+03, &                                     ! 11: NH3
       2.1393E+05, 1.4313E+05, &                                     ! 12: HNO3
       8.0348E+01, 8.0881E+01, 2.0931E+02, &                         ! 13: OH
       4.1469E+01, 1.1592E+02, &                                     ! 14: HF
       1.6065E+02, 1.6089E+02, 4.6278E+02, 4.6413E+02, &             ! 15: HCl
       2.0017E+02, 2.0024E+02, 5.8640E+02, 5.8676E+02, &             ! 16: HBr
       3.8899E+02, 1.1471E+03, &                                     ! 17: HI
       3.2918E+03, 3.3492E+03, &                                     ! 18: ClO
       1.2164E+03, 1.2488E+03, 2.4746E+03, 4.9313E+03, 1.3048E+03, & ! 19: OCS
       2.5416E+03, &
       ...
       3.8860E+04, 7.9038E+04, &                                     ! 32: HCOOH
       4.2998E+03, &                                                 ! 33: HO2
       6.7212E+00, &                                                 ! 34: O
       ...
       9.8215E+03, &                                                 ! 43: C4H2
       2.4711E+04, &                                                 ! 44: HC3N
       7.6712E+00, 2.9875E+01, &                                     ! 45: H2
       2.5318E+02, 2.5774E+02, 5.3745E+02, 1.0229E+03, &             ! 46: CS
       7.7833E+03, &                                                 ! 47: SO3
       1.5585E+04, &                                                 ! 48: C2N2
       1.4800E+06, 3.0435E+06, &                                     ! 49: COCl2
       8.4288E+02, 8.5973E+02, 9.1052E+02, &                         ! 50: SO
       1.4707E+04, 3.0239E+04, &                                     ! 51: CH3F
       1.7151E+03, 1.7149E+03, 1.7148E+03, 1.7150E+04, 1.7153E+03, & ! 52: GeH4
       1.3465E+03, 2.7848E+03, 1.0958E+04, 2.7543E+03, &             ! 53: CS2
       1.6427E+05, &                                                 ! 54: CH3I
       3.4773E+05, &                                                 ! 55: NF3
       5.0355E+01, &                                                 ! 56: H3+
       6.6867E+02, &                                                 ! 57: CH3
       1.0067E+03, &                                                 ! 58: S2
       6.2094E+05, 6.4040E+05, &                                     ! 59: COFCl
       8.5076E+04, &                                                 ! 60: HONO
       4.7838E+05, 4.9380E+05 /)                                     ! 61: ClNO2
...
! using internal subroutine read_parsum_dat.
  ...
  REAL(RealK), Parameter, DIMENSION(1:number_species) :: iso_mass = &
    (/  18.010565,  20.014811,  19.014780,  19.016740,  21.020985, & !  1: H2O
        ...
        45.992904,  46.989938,  47.997149, &                         ! 10: NO2
       ...
       141.927947, &                                                 ! 54: CH3I
        ...
        15.023475, &                                                 ! 57: CH3
        63.944140, &                                                 ! 58: S2
        81.962172,  83.959223, &                                     ! 59: COFCl
        47.000729, &                                                 ! 60: HONO
        80.961757,  82.958808 /)                                     ! 61: ClNO2
