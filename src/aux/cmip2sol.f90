...
! *****************************COPYRIGHT*******************************
!
! Mean the SOLARIS-HEPPA CMIP7 solar forcing spectra over a given time period
!
! The input CMIP7 solar forcing data come from:
! Funke et al. (2024), GMD, 17, DOI:10.5194/gmd-17-1217-2024
