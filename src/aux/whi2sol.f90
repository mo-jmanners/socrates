...
! *****************************COPYRIGHT*******************************
!
! Mean the WHI Reference spectra over the three observation periods
!
! Whole Heliosphere Interval (WHI) Reference Spectra data come from:
! Woods et al. (2009), GRL, 36, L01101, DOI:10.1029/2008GL036373
