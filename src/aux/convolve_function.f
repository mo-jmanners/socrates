...
!
!- ---------------------------------------------------------------------
      SUBROUTINE convolve_function(ierr, n_band
...
!           Wavenumbers of filter points
     &  , wavenumber_filter_ord(npd_filter)
!           Ord. wavenumbers of filter points
     &  , trans_filter(npd_filter)
!           Transmittance of filter
     &  , trans_filter_ord(npd_filter)
!           Ord. transmittance of filter
     &  , second_derivative(npd_filter)
