...
Blocks 5 \& 9 require output from the {\tt corr\_k} program.
Blocks 10, 11 \& 12 use output from {\tt scatter\_average}. Block 2 
requires a solar spectrum (examples are in \$RAD\_DATA/solar/).
Block 17 requires high-resolution solar spectral variability data files. Formats accepted are currently: CMIP5 (available from http://solarisheppa.geomar.de/cmip5).
