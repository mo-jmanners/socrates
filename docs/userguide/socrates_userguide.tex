...
\input{scat_gen}
\section{Generating Scattering data for aerosols}
\input{aero_scat}
\section{Generating Scattering data for water droplets}
\input{drop_scat}
\section{Generating Scattering data for ice crystals}
\input{icedbs}
